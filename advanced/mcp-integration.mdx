...
MCP integration enables memory management through interaction between Claude, the memory system, and ChromaDB.
...
MCP server configured automatically during installation:
