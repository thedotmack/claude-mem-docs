...
Transform Claude Code transcripts into searchable memory documents. Analyze conversations, extract insights, and store in a vector database.

## Core Classes

### TranscriptCompressor

Main compression engine for Claude Code transcripts.
...
Handle large transcripts exceeding token limits through chunking.
...
Manage prompt generation for LLM analysis.
...
Process various message types from transcripts:
