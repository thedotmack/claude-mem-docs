...
Already installed? This guide shows you how to make the most of claude-mem.

## Understanding What You've Got

When you installed claude-mem, you gained:

<CardGrid>
  <Card title="Instant Memory" icon="brain">
    Every conversation is automatically remembered and searchable
  </Card>
  <Card title="Smart Context" icon="sparkles">
    Relevant memories load automatically when you start coding
  </Card>
  <Card title="Zero Effort" icon="wand-magic-sparkles">
    No commands needed - everything happens automatically
  </Card>
...
This happens automatically. No commands. No configuration.
