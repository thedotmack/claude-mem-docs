...
Everything below kicks in after a single install. Most workflows are automatic, and we call out the few optional switches so you know when something needs your input.
...
**Never lose anything.** Smart Trash™ keeps everything recoverable and restores one item at a time so you always know what changed.
...
**No exact matches needed.** Semantic search is available whenever you call the tool.
