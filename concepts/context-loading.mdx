...
Understanding how claude-mem selects, filters, and presents memories to Claude Code is key to maximizing the effectiveness of your persistent context system.

## Loading Process Overview

When Claude Code starts, the context loading system performs several intelligent operations to provide the most relevant memories:
...
claude-mem stores memories in a JSONL (JSON Lines) format for efficient streaming and processing:
